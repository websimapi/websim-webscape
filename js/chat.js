...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (chatWindow) {
    ...
    // Export the showMessageOverlay function for friends.js
    window.showMessageOverlay = showMessageOverlay;

    // Import the setMessageHandler from friends.js and set it up
    import { setMessageHandler } from './features/friends.js';
    setMessageHandler(showMessageOverlay);
